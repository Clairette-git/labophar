      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/services" className="text-gray-700 hover:text-teal-600 font-medium">
              Services
            </Link>
            <Link href="/expansion" className="text-gray-700 hover:text-teal-600 font-medium">
              Expansion
            </Link>
            <Button asChild className="bg-teal-600 hover:bg-teal-700 border-2 border-teal-500 shadow-sm">
